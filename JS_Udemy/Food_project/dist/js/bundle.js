...
function calc() {
  var genderItems = document.querySelectorAll(".calculating_gender");
  var chooseActivity = document.querySelectorAll(".calculating__choose_big div");
  var inputsArray = document.querySelectorAll(".calculating__choose_medium input");
  var textResult = document.querySelector(".calculating__result span");
  ...
  chooseActivity.forEach(function (e) {
    e.addEventListener("click", function () {
      calculatingResult();
      localStorage.setItem("activity", "".concat(e.dataset.activity));
    });
  });
  genderItems.forEach(function (e) {
    e.addEventListener("click", function () {
      calculatingResult();
      localStorage.setItem("sex", "".concat(e.innerText));
    });
  });
  ...
  function setItemActive(array) {
    //set class "calculating__choose-item_active" for next work
    array.forEach(function (e) {
      e.addEventListener("click", function (event) {
        array.forEach(function (e) {
          return e.classList.remove("calculating__choose-item_active");
        });
  ...
  function calculatingResult() {
    if (!inputsArray[0].value || !inputsArray[1].value || !inputsArray[2].value) {
      ...
      var returnItemParametrs = function returnItemParametrs(array) {
        //genderItems     //choose the sex and get result
        var result = null;
      ...
      var returnItemActivity = function returnItemActivity(array) {
        //chooseActivity
        var result = null;
        array.forEach(function (item) {
...
function classes(containerClass) {
  var MenuItem = /*#__PURE__*/function () {
    //create class
    function MenuItem(img, alt, subtitle, describe, total) {
    ...
    _createClass(MenuItem, [{
      ...
      value: function setItems() {
        return "<div class=\"menu__item\">\n            <img src=".concat(this.imgSRC, " alt=").concat(this.alt, ">\n            <h3 class=\"menu__item-subtitle\">").concat(this.subtitle, "</h3>\n            <div class=\"menu__item-descr\">").concat(this.describe, "</div>\n            <div class=\"menu__item-divider\"></div>\n            <div class=\"menu__item-price\">\n                <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                <div class=\"menu__item-total\"><span>").concat(MenuItem.convertorToBYN(this.costTotal), "</span> BYN/\u0434\u0435\u043D\u044C</div>\n            </div>\n        </div>");
      }
    }], [{
      key: "convertorToBYN",
      value: function convertorToBYN(price) {
  ...
  var container = document.querySelector(containerClass); //clear cards

  container.innerHTML = '';
  (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getItemsFromServer)("http://localhost:3000/menu") //post it to cards of the content
  .then(function (data) {
...
/* harmony import */ var _modalWIndow__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modalWIndow */ "./js/modalWIndow.js");
...
function forms(formSlector) {
  var forms = document.querySelectorAll(formSlector);
  var message = {
  ...
  function bindPostData(form, objectMessage) {
    form.addEventListener("submit", function (event) {
      event.preventDefault();
      var formData = new FormData(form); //get formses data
      ...
      form.insertAdjacentElement("afterend", statusMessage);
      formsTimer(form, statusMessage, 2000);
      var json = JSON.stringify(Object.fromEntries(formData.entries())); //from formData to JSON
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_10__.postData)("http://localhost:3000/requests", "POST", json).then(function (result) {
  ...
  function showThanksModal(status) {
    _modalWIndow__WEBPACK_IMPORTED_MODULE_9__.modalWindow.style.display = "block"; ///do modal window block

    var modalContentFormToNone = document.querySelector(".modal__content form"); //forms = none

    modalContentFormToNone.style.display = "none";
    var modalContent = document.querySelector(".modal__content"); //get empty modal content

    var statusMessageInModal = document.createElement("div"); //create message content for modal window
    ...
    setTimeout(function () {
      _modalWIndow__WEBPACK_IMPORTED_MODULE_9__.modalWindow.style.display = "none"; //close modal window
...
function modal() {
  var btnWhite = document.querySelector(".btn_white");
...
var postData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, method, targetBody) {
    var result;
...
var getItemsFromServer = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fetch ".concat(url, ", status ").concat(data.status));
  ...
  return function getItemsFromServer(_x4) {
...
function slider(_ref) {
  var sliderWrap = _ref.sliderWrap,
      innerWrap = _ref.innerWrap,
      slideArray = _ref.slideArray,
      mainSlider = _ref.mainSlider,
      currentNumb = _ref.currentNumb,
      totalNumb = _ref.totalNumb,
      nextButton = _ref.nextButton,
      prevButton = _ref.prevButton;
  var wrapper = document.querySelector(sliderWrap);
  var innerWrapper = document.querySelector(innerWrap);
  var slidersArray = document.querySelectorAll(slideArray);
  var sliderCurrent = document.querySelector(currentNumb);
  var sliderTotal = document.querySelector(totalNumb);
  var btnNext = document.querySelector(nextButton);
  var btnPrev = document.querySelector(prevButton);
  var width = +window.getComputedStyle(wrapper).width.replace(/\D/gi, ""); //get width of wrapper 

  var index = 1;
  var offset = 0;
  innerWrapper.style.width = "".concat(100 * slidersArray.length, "%"); //do width of innerWrapper * array.length

  innerWrapper.style.display = "flex"; //default direction is row

  innerWrapper.style.transition = "all .5s";
  wrapper.style.overflow = "hidden";
  slidersArray.forEach(function (e) {
    return e.style.width = width;
  }); //do all slidersPicture = width  

  sliderTotal.innerText = slidersArray.length >= 10 ? slidersArray.length : "0".concat(slidersArray.length);
  ...
  var slider = document.querySelector(mainSlider); //get ALL slider

  slider.style.position = "relative"; //dotsField`s position is absolute in slider

  var dotsField = document.createElement("div"); //create dotsField

  dotsField.classList.add("dotsField");
  dotsField.style.cssText = "\n        position: absolute;\n        right: 0;\n        bottom: 0;\n        left: 0;\n        z-index: 15;\n        display: flex;\n        justify-content: center;\n        margin-right: 15%;\n        margin-left: 15%;\n        list-style: none;\n    ";
  slidersArray.forEach(function () {
    var createDots = document.createElement("div"); //create dots

    createDots.classList.add("dots");
    dotsField.appendChild(createDots); //and append them to parent
  });
  var dotsArray = dotsField.querySelectorAll(".dots"); //get array of the dots in them field
  ...
  function setCurrent(array, current) {
    ...
    current.textContent = index >= 10 ? index : "0".concat(index);
  }
...
function tabs(tabHeaderParentClass, tabContent, itemClass, activeClass) {
  var tabheaderItemsParent = document.querySelector(tabHeaderParentClass);
...
function timer(timerSelector, dateString) {
  function getTimeMS() {
    var between = new Date(dateString) - new Date();
    return between;
  }

  var timerItems = document.querySelector(timerSelector);

  function setTimer(timer) {
    var resultMS = +getTimeMS();
    ...
    timer.innerHTML = "\n            <div class=\"timer__block\">\n            <span id=\"days\">".concat(days < 10 ? '0' + days : days, "</span>\n            \u0434\u043D\u0435\u0439\n        </div>\n        <div class=\"timer__block\">\n            <span id=\"hours\">").concat(hours < 10 ? '0' + hours : hours, "</span>\n            \u0447\u0430\u0441\u043E\u0432\n        </div>\n        <div class=\"timer__block\">\n            <span id=\"minutes\">").concat(minutes < 10 ? '0' + minutes : minutes, "</span>\n            \u043C\u0438\u043D\u0443\u0442\n        </div>\n        <div class=\"timer__block\">\n            <span id=\"seconds\">").concat(seconds < 10 ? '0' + seconds : seconds, "</span>\n            \u0441\u0435\u043A\u0443\u043D\u0434\n        </div>\n        ");
